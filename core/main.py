...
if __name__ == '__main__':
    ...
    parser.add_argument('--top_instance_diversity_lambda', default=1.0, type=float,
        help='MMR lambda for diverse top-instance aggregation; 1.0 keeps original top-logit selection')
